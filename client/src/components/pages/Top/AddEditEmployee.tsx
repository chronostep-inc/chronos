...
const AddEditEmployee = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className='text-2xl font-semibold mb-4'>{employeeIdToEdit ? 'Edit Employee':'Employee Form'}</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {employeeIdToEdit && selectedEmployee && [1, 2, 23].includes(selectedEmployee.role.type) ? null : (
            <div className='mb-4'>
